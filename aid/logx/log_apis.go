...
func ShowDebug() bool {
	return myCnf.iLevel <= LogLevelDebug
}

func ShowInfo() bool {
	return myCnf.iLevel <= LogLevelInfo
}

func ShowWarn() bool {
	return myCnf.iLevel <= LogLevelWarn
}

func ShowError() bool {
	return myCnf.iLevel <= LogLevelError
}

func ShowStack() bool {
	return myCnf.iLevel <= LogLevelStack
}
