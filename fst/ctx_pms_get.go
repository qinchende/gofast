...
func (c *Context) Get(key string) (val any, ok bool) {
	val, ok = c.Pms.Get(key)
	return
}

func (c *Context) GetMust(key string) any {
	if val, ok := c.Pms.Get(key); ok {
		return val
	}
...
func (c *Context) GetString(key string) (string, error) {
	if v, ok := c.Pms.Get(key); ok {
		return lang2.ToString2(v)
	}
	return "", errorKeyNotExist
}

func (c *Context) GetStringDef(key string, def string) string {
	if v, ok := c.Pms.Get(key); ok && v != nil {
		v2, err2 := lang2.ToString2(v)
		cst.PanicIfErr(err2)
		return v2
	}
	return def
...
func (c *Context) GetStringMust(key string) string {
	v, err := lang2.ToString2(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetBoolMust(key string) bool {
	v, err := lang2.ToBool(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetInt64Must(key string) int64 {
	v, err := lang2.ToInt64(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetIntMust(key string) int {
	v, err := lang2.ToInt(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetInt32Must(key string) int32 {
	v, err := lang2.ToInt32(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetInt16Must(key string) int16 {
	v, err := lang2.ToInt16(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetInt8Must(key string) int8 {
	v, err := lang2.ToInt8(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetUint64Must(key string) uint64 {
	v, err := lang2.ToUint64(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetUintMust(key string) uint {
	v, err := lang2.ToUint(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetUint32Must(key string) uint32 {
	v, err := lang2.ToUint32(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetUint16Must(key string) uint16 {
	v, err := lang2.ToUint16(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetUint8Must(key string) uint8 {
	v, err := lang2.ToUint8(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetFloat64Must(key string) float64 {
	v, err := lang2.ToFloat64(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetFloat32Must(key string) float32 {
	v, err := lang2.ToFloat32(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetTimeMust(key string) *time.Time {
	v, err := lang2.ToTime("", c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
func (c *Context) GetDurationMust(key string) time.Duration {
	v, err := lang2.ToDuration(c.GetMust(key))
	cst.PanicIfErr(err)
	return v
}
...
//	if val, ok := c.Pms.Get(key); ok && val != nil {
