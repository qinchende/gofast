...
//
//	assert.Nil(t, binding.validate(test))
//	assert.Nil(t, binding.validate(&test))
//	assert.Nil(t, binding.validate(empty))
//	assert.Nil(t, binding.validate(&empty))
//
...
//	assert.NoError(t, binding.validate(obj))
//	assert.NoError(t, binding.validate(&obj))
//	assert.Equal(t, Object{"foo": "bar", "bar": 1}, obj)
//
//	obj2 := []Object{{"foo": "bar", "bar": 1}, {"foo": "bar", "bar": 1}}
//	assert.NoError(t, binding.validate(obj2))
//	assert.NoError(t, binding.validate(&obj2))
//
//	nu := 10
//	assert.NoError(t, binding.validate(nu))
//	assert.NoError(t, binding.validate(&nu))
//	assert.Equal(t, 10, nu)
//
//	str := "value"
//	assert.NoError(t, binding.validate(str))
//	assert.NoError(t, binding.validate(&str))
