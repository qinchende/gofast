...
//
//		_, err := binding.mapping(val, binding.emptyField, binding.formSource{field.Name: {tt.form}}, "form")
...
//		B int `form:"-"`
//	}
//	err := binding.mappingByPtr(&s, binding.formSource{"A": {"9"}, "B": {"9"}}, "form")
//	assert.NoError(t, err)
//
...
//		f int `form:"field"`
//	}
//	err := binding.mappingByPtr(&s, binding.formSource{"field": {"6"}}, "form")
//	assert.NoError(t, err)
...
//	}
//
//	err := binding.mappingByPtr(&s, binding.formSource{"U": {"unknown"}}, "form")
//	assert.Error(t, err)
//	assert.Equal(t, binding.errUnknownType, err)
//}
//
...
//		F int `uri:"field"`
//	}
//	err := binding.mapUri(&s, map[string][]string{"field": {"6"}})
//	assert.NoError(t, err)
...
//		F int `form:"field"`
//	}
//	err := binding.mapForm(&s, map[string][]string{"field": {"6"}})
//	assert.NoError(t, err)
//	assert.Equal(t, int(6), s.F)
//}
//
...
//	assert.NoError(t, err)
//
//	err = binding.mapForm(&s, map[string][]string{
...
//	}
//	err = binding.mapForm(&wrongLoc, map[string][]string{"Time": {"2019-01-20T16:02:58Z"}})
//	assert.Error(t, err)
//
//	// wrong time value
...
//		Time time.Time
//	}
//	err = binding.mapForm(&wrongTime, map[string][]string{"Time": {"wrong"}})
//	assert.Error(t, err)
//}
//
...
//
//	// ok
//	err := binding.mappingByPtr(&s, binding.formSource{"D": {"5s"}}, "form")
//	assert.NoError(t, err)
//	assert.Equal(t, 5*time.Second, s.D)
//
//	// error
//	err = binding.mappingByPtr(&s, binding.formSource{"D": {"wrong"}}, "form")
//	assert.Error(t, err)
//}
//
...
//
//	// ok
//	err = binding.mappingByPtr(&s, binding.formSource{"slice": {"3", "4"}}, "form")
//	assert.NoError(t, err)
//	assert.Equal(t, []int{3, 4}, s.Slice)
//
//	// error
//	err = binding.mappingByPtr(&s, binding.formSource{"slice": {"wrong"}}, "form")
//	assert.Error(t, err)
//}
//
...
//
//	// ok
//	err = binding.mappingByPtr(&s, binding.formSource{"array": {"3", "4"}}, "form")
//	assert.NoError(t, err)
//	assert.Equal(t, [2]int{3, 4}, s.Array)
//
//	// error - not enough vals
//	err = binding.mappingByPtr(&s, binding.formSource{"array": {"3"}}, "form")
//	assert.Error(t, err)
//
//	// error - wrong value
//	err = binding.mappingByPtr(&s, binding.formSource{"array": {"wrong"}}, "form")
//	assert.Error(t, err)
//}
//
...
//	}
//
//	err := binding.mappingByPtr(&s, binding.formSource{"J": {`{"I": 9}`}}, "form")
//	assert.NoError(t, err)
...
//	}
//
//	err := binding.mappingByPtr(&s, binding.formSource{"M": {`{"one": 1}`}}, "form")
//	assert.NoError(t, err)
